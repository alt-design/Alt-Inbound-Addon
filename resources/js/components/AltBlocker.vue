    ...
    methods: {
        ...
        deleteRedirect(ip, id) {
            if (confirm('Are you sure you want to delete this block?')) {
                Statamic.$axios.post(cp_url('alt-design/alt-blocker/delete'), {
                    ip: ip,
                    id: id
                }).then(res => {
        ...
        importFromCSV() {
            ...
            Statamic.$axios.post(cp_url('alt-design/alt-blocker/import'), formData, {
                headers: {
        ...
        blacklistChange() {
            ...
            Statamic.$axios.post(cp_url('alt-design/alt-blocker/blacklist'), formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            }).then(res => {
        ...
        viewChanged() {
            ...
            Statamic.$axios.post(cp_url('alt-design/alt-blocker/custom-view'), formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            }).then(res => {
    ...
    <div id="alt-redirect">
        ...
        <div class="card overflow-hidden p-0">
            <div class="mt-4 pb-2 px-4 flex items-center">
                <div class="w-1/3 flex items-center">
                    ...
                    <div class=" pl-4 text-sm">Whitelist / Blacklist</div>
                </div>
        ...
        <div class="flex justify-between">
            <div class="w-full xl:w-1/2 card overflow-hidden p-0 mb-4 mt-4 mr-4 px-4 py-4">
                ...
                <a class="btn-primary" :href="cp_url('/alt-design/alt-blocker/export')" download>Export CSV</a>
            </div>
